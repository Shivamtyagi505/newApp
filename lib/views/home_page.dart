...
import 'package:news_app/views/bookmarked.dart';
    ...
    return GetBuilder<NewsController>(builder: (_) {
      return Scaffold(
          ...
          bottomNavigationBar: BottomNavigationBar(
            ...
            currentIndex: newsController.selectedTab,
            iconSize: 35,
            onTap: (i) => newsController.handleIndexChanged(i),
          ));
    });
  }
}
                  ...
                  Flexible(
                    ...
                    child: Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: const InputDecoration(border: InputBorder.none, hintText: "Search News"),
                        onChanged: (val) {
                        ...
                        onSubmitted: (value) async {
                          ...
                          newsController.getAllNews(searchKey: newsController.searchNews.value);
                            ...
                            : Builder(builder: (BuildContext context) {
                                try {
                                  return Banner(
                                    ...
                                    child: InkWell(
                                      onTap: () => Get.to(() => WebViewNews(newsUrl: instance.url!)),
                                            ...
                                            child: Container(
                                              decoration: BoxDecoration(
                                                  ...
                                                  gradient: LinearGradient(
                                                      colors: [Colors.black12.withOpacity(0), Colors.black], begin: Alignment.topCenter, end: Alignment.bottomCenter)),
                                              child: Container(
                                                  ...
                                                  child: Container(
                                                      ...
                                                      child: Text(
                                                        instance.title ?? '',
                                                        style: const TextStyle(fontSize: Sizes.dimen_16, color: Colors.white, fontWeight: FontWeight.bold),
                                                      ))),
                                            )),
                                      ]),
                                    ),
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              index == controller.allNews.length - 1 && controller.isLoading.isTrue
                                  ...
                                  : const SizedBox();
                              return InkWell(
                                onTap: () => Get.to(() => NewsDetailsPage(data: controller.allNews[index])),
                                child: NewsCard(data: controller.allNews[index]),
                              );
                            });
              }),
        ],
