        ...
        GetBuilder<NewsController>(
          builder: (controller) {
            return Container(
              ...
              padding: const EdgeInsets.symmetric(horizontal: Sizes.dimen_18, vertical: Sizes.dimen_18),
              child: Column(
                ...
                children: [
                  controller.cName.isNotEmpty
                      ? Text(
                          ...
                          style: const TextStyle(color: AppColors.white, fontSize: Sizes.dimen_18),
                        )
            ...
            for (int i = 0; i < listOfNewsChannel.length; i++)
              drawerDropDown(
                onCalled: () {
                  ...
                  newsController.getAllNews(channel: listOfNewsChannel[i]['code']);
