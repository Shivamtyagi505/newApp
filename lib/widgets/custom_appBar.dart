...
customAppBar(String title, BuildContext context, {bool? automaticallyImplyLeading, Widget? leading, List<Widget>? actions}) {
  ...
  return AppBar(
    ...
    title: Column(
      children: [
        ...
        Text(
          title,
          style: textTheme.headline5!.copyWith(fontSize: Sizes.dimen_22, color: AppColors.white, fontWeight: FontWeight.w600),
